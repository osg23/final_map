...
lyr_Routes_2.set('fieldAliases', {'fid': 'fid', 'DEL_cost': 'DEL_cost', 'RID': 'RID', 'Pick_time': 'Pick_time', 'Delivery_time': 'Delivery_time', });
...
lyr_Routes_2.set('fieldImages', {'fid': 'TextEdit', 'DEL_cost': 'TextEdit', 'RID': 'TextEdit', 'Pick_time': '', 'Delivery_time': '', });
...
lyr_Routes_2.set('fieldLabels', {'fid': 'header label', 'DEL_cost': 'header label', 'RID': 'header label', 'Pick_time': 'header label', 'Delivery_time': 'header label', });
lyr_Pick_ups_3.set('fieldLabels', {'PID': 'header label', 'P_ADDRESS': 'header label', 'D_ADDRESS': 'header label', });
lyr_Deliveries_4.set('fieldLabels', {'DID': 'header label', 'D_ADDRESS': 'header label', });
